// This component was not made by me. It was found and adapted from: https://www.reactbits.dev/animations/splash-cursor
  ...
  useEffect(() => {
    ...
    function getWebGLContext(
      ...
      if (!formatRGBA || !formatRG || !formatR) {
        throw new Error('Required texture format is not supported by this browser.');
      }
